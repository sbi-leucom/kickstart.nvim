...
if vim.opt.shell == '/usr/bin/bash.exe' then
  -- Set cmd
  -- vim.g.cmdhost = '/c/WINDOWS/system32/cmd.exe'
  -- Set node
  -- vim.g.node_host_prog = '/c/Users/sbischof/.npm/neovim-node-host'
  vim.g.node_host_prog = '/c/Users/sbischof/node_modules/neovim/bin/cli.js'
  -- Set python
  ...
  if vim.env.MSYSTEM == 'MSYS' then
    ...
    vim.g.perl_host_prog = '/mingw64/bin/perl'
  end
  -- Set ruby
  ...
  -- vim.g.cmdhost = '"C:\\WINDOWS\\system32\\cmd.exe"'
  -- Set node
  vim.g.node_host_prog = '"C:\\Users\\sbischof\\node_modules\\neovim\\bin\\cli.js"'
  -- Set python
  vim.g.python_host_prog = '"C:\\Users\\sbischof\\.venv-neovim\\Scripts\\python.exe"'
  vim.g.python3_host_prog = '"C:\\Users\\sbischof\\.venv-neovim\\Scripts\\python.exe"'
end
