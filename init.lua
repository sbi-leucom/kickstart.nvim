-- suppress "Press Enter" prompts just in case
...
--]]
    ...
    { -- Highlight, edit, and navigate code
      ...
      config = function(_, opts)
        ...
        --require('nvim-treesitter.install').compilers = { 'zig', 'llvm', 'clang', 'gcc', 'cc' }
        --require('nvim-treesitter.install').compilers = { 'llvm', 'clang', 'gcc', 'cc' }
        -- apply the treesitter config
